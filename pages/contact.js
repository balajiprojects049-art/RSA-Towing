  ...
  return (
    <div>
      <PageHero
        ...
        subtitle="Our team is available round-the-clock for emergency roadside support. Reach us via phone, WhatsApp, or email for immediate assistance."
        image="/images/contact-hero-gen.png"
      />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-20">
        <div className="grid md:grid-cols-2 gap-8 md:gap-12">
          {/* Contact Information */}
          <div>
            <h2 className="text-2xl md:text-3xl font-display font-black mb-8">Quick Contact</h2>
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-2xl font-display font-black text-accent break-all">+91 9512291229</div>
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-lg font-bold text-blue-500 break-all">rsatowing24x7@gmail.com</div>
          ...
          {/* Contact Form */}
          <div>
            <h2 className="text-2xl md:text-3xl font-display font-black mb-8">Send Message</h2>
        ...
        {/* Google Maps Section */}
        <div className="mt-12 md:mt-20">
          <h2 className="text-2xl md:text-3xl font-display font-black mb-8 text-center">Our Location</h2>
