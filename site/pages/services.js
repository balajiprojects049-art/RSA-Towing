  ...
  const services = [
    {
      ...
      desc: 'Professional sedan and SUV towing with flatbed or wheel-lift options for all makes and models.',
      features: [
        'All makes & models supported (Maruti, Hyundai, Honda, Toyota, etc.)',
        'Real-time GPS tracking with SMS updates',
        'Insurance claim documentation assistance',
        '100% damage-free guarantee with certified operators',
        'Available 24/7/365 across Pan India',
        'Wheelchair vehicle and tow truck options'
      ],
    ...
    },
    {
      ...
      desc: 'Specialized motorcycle towing with custom rigs designed for safe transport of all two-wheelers.',
      features: [
        'Sport bikes to cruisers - all types covered',
        'Soft tie-down straps prevent any scratches',
        'Vertical or horizontal loading options',
        'Premium bike coverage for Royal Enfield, KTM, Harley',
        'Expert handlers trained for superbikes',
        'Secure loading ramps and wheel chocks'
      ],
    ...
    },
    {
      ...
      desc: 'Heavy-duty flatbed towing for luxury cars, lowered vehicles, and long-distance transport.',
      features: [
        'Zero wheel contact - complete off-ground transport',
        'Exotic car specialists (Mercedes, BMW, Audi)',
        'Long-distance interstate transport available',
        'Multi-vehicle hauling capability',
        'Climate-controlled transport options',
        'Hydraulic lift beds for smooth loading'
      ],
    ...
    },
    {
      ...
      desc: 'On-site battery testing, jump-starting, and replacement services to get you moving quickly.',
      features: [
        'Under 15-minute arrival time in cities',
        'Professional battery diagnostic testing',
        'Quality battery sales (Amaron, Exide)',
        'Free installation with purchase',
        'Warranty coverage on new batteries',
